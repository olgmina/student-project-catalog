...
- Функциональность
  ...
  - [Прототип мобильного приложения Навигатор гостя Университета](#Прототип мобильного приложения Навигатор гостя Университета)
- Техники
...
- Инструменты
  ...
  - [метод отсеивания тупиков](#Прототип мобильного приложения Навигатор гостя Университета)
- Паттерны
  ...
  - [DAO](#Прототип мобильного приложения Навигатор гостя Университета)
  - [Singleton](#Прототип мобильного приложения Навигатор гостя Университета)
- Архитектуруы
  - [Model-View-ViewModel (MVVM)](#калькулятор)
  - [MVC (модель, представление, контроллер)](#Прототип мобильного приложения Навигатор гостя Университета)
...
## [Прототип мобильного приложения Навигатор гостя Университета](ссылка)
